...
import data from '../data/data.json';  // Importar el archivo JSON local
...
const ProductInfoPage = () => {
    ...
    return (
        <Box sx={{ padding: 4, maxWidth: '100%', margin: 'auto' }}>
            <Button component={Link} to="/" sx={{ marginBottom: 2, position: 'absolute', top: 16, left: 16 }}>← Volver</Button>
