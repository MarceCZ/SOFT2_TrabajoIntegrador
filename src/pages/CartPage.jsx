      ...
      <Box sx={{ padding: '20px' }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid container alignItems="center" sx={{ fontWeight: 'bold', mb: 2 }}>
            <Grid item xs={12} md={6} sx={{ paddingLeft: '90px' }}>
          ...
          >
            <Typography variant="h6" sx={{ marginBottom: '10px' }}>Resumen de compra</Typography>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
              <Typography variant="body1">Subtotal</Typography>
              <Typography variant="body1" sx={{ fontWeight: 'bold' }}>S/ {totalCartPrice}</Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', marginBottom: '10px' }}>
